...
<body>
    ...
    <div class="content">
        ...
        <p>All you have to do now is upload your website files and start your journey. Check out how to do that below:
        </p>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="blog-slider__imgs">
                        ...
                        <img class="back-image" alt="" src="assets/images/procurement.png" />
                        <div class="movie-image-container">

                            <img class="movie-image  blog-slider__img" alt="" src="assets/images/procurement.png" />
                            <div class="overly">
                                <a href="#" title="-1">
                    ...
                    <div class="blog-slider__content">
                        ...
                        <p class="blog-slider__text">
                            Procurement Monitoring System allows you to monitor the status of the purchase of a product.
                        </p>
                ...
                <div class="swiper-slide">
                    <div class="blog-slider__imgs">
                        <img class="back-image" alt="" src="assets/images/attendance-camera.png" />
                        <div class="movie-image-container">

                            <img class="movie-image  blog-slider__img" alt=""
                                src="assets/images/attendance-camera.png" />
                            <div class="overly">
                                <a href="#" title="-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                    ...
                    <div class="blog-slider__content">
                        ...
                        <p class="blog-slider__text">
                            This will be the most popular face recognition
                        </p>
                        <!-- <span class="blog-slider__rate">
                        IMDB 7.5/10
                    </span> -->
                ...
                <div class="swiper-slide">
                    <div class="blog-slider__imgs">
                        <img class="back-image" alt="" src="assets/images/Attendance.png" />
                        <div class="movie-image-container">

                            <img class="movie-image  blog-slider__img" alt="" src="assets/images/Attendance.png" />
                            <div class="overly">
                                <a href="#" title="-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                    ...
                    <div class="blog-slider__content">
                        ...
                        <p class="blog-slider__text">
                            Attendance System is a web-base system that provides a variety of different implementations,
                            automate access of some doxuments.
                        </p>
                        <!-- <span class="blog-slider__rate">
                        IMDB 3.7/10
                    </span> -->
                ...
                <div class="swiper-slide">
                    <div class="blog-slider__imgs">
                        <img class="back-image" alt="" src="assets/images/BMS.png" />
                        <div class="movie-image-container">

                            <img class="movie-image  blog-slider__img" alt="" src="assets/images/BMS.png" />
                            <div class="overly">
                                <a href="#" title="-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                    ...
                    <div class="blog-slider__content">
                        ...
                        <p class="blog-slider__text">
                            ...
                            Baranagy Management System is a service provider that provides access to the information,
                            allow
                            to manage the information of the town.
                        </p>
                        <!-- <span class="blog-slider__rate">
                        IMDB 3.7/10
                    </span> -->
                ...
                <div class="swiper-slide">
                    <div class="blog-slider__imgs">
                        <img class="back-image  blog-slider__backimg" alt="" src="assets/images/Tracking.png" />
                        <div class="movie-image-container">

                            <img class="movie-image  blog-slider__img" alt="" src="assets/images/Tracking.png" />
                            <div class="overly">
                                <a href="#" title="-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                    ...
                    <div class="blog-slider__content">
                        ...
                        <p class="blog-slider__text">
                            Tracking System is used to track documents, which means that you can access them.
                        </p>
                        <!-- <span class="blog-slider__rate">
                        IMDB 3.7/10
                    </span> -->
